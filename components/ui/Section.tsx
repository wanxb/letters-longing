    ...
    <section className="py-14 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-9 grid gap-5 border-b border-paper-200 pb-6 md:grid-cols-[0.8fr_1fr] md:items-end">
          <div>
            {eyebrow ? <p className="mb-3 text-xs font-medium uppercase tracking-[0.2em] text-seal-700">{eyebrow}</p> : null}
            <h2 className="font-serif text-4xl font-semibold tracking-normal text-ink-950 sm:text-5xl">{title}</h2>
          </div>
